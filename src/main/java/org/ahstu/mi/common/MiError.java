...
public enum MiError {
    ...
    INSIST_ADDLOCK_ISNULL("INSIST_ADDLOCK_ISNULL","加锁异常，锁不存在或者ID是空"),
    INSIST_ADDLOCK_EXIST("INSIST_ADDLOCK_EXIST","加锁异常，锁ID重复"),
    INSIST_ILLEGAL_ARGUMENT("INSIST_ILLEGAL_ARGUMENT","INSIST参数异常"),
    INSIST_ZK_HOST_ISNULL("INSIST_ZK_HOST_ISNULL","注册地址是空"),
    INSIST_IPPORTKEY_ISNULL("INSIST_IPPORTKEY_ISNULL","IP和PORT是空"),
    ...
    INSIST_RESULT_IS_NULL("INSIST_RESULT_IS_NULL","返回insist-result为空")
    ;
