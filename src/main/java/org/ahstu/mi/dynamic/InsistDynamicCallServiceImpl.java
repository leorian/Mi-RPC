 ...
 */
public class InsistDynamicCallServiceImpl implements InsistDynamicCallService {
    ...
    public Object listInterfaceMethod(MiDynamicDTO insistDynamicDTO) {
        ...
        List<InsistServiceMethodDO> insistServiceMethodDOList = new ArrayList<InsistServiceMethodDO>();
        for (Method method : providerClass.getDeclaredMethods()) {
            InsistServiceMethodDO insistServiceMethodDO = new InsistServiceMethodDO();
            ...
            if (insistServiceMethodDO.getInsistServiceMethodParameterDOList() == null) {
                insistServiceMethodDO.setInsistServiceMethodParameterDOList(new ArrayList<InsistServiceMethodParameterDO>());
            }
            ...
            for (Type type : method.getGenericParameterTypes()) {
                ...
                InsistServiceMethodParameterDO insistServiceMethodParameterDO = new InsistServiceMethodParameterDO();
